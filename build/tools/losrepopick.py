...
#
# Run losrepopick.py -h for a description of this utility.
#
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
        losrepopick.py is a utility to simplify the process of cherry picking
        patches from LineageOS's Gerrit instance (or any gerrit instance of your choosing)

        Given a list of change numbers, losrepopick will cd into the project path
        ...
        --start-branch option, will cause losrepopick to abandon the specified
    ...
    for item in mergables:
        ...
        ctosp_project_name = 'platform/' + remove_prefix(item['project'], 'android_').replace('_','/')
        ...
        elif ctosp_project_name in project_name_to_data:
            print('\nAOSP Project found: {0}, resolving as {1}\n'.format(item['project'], ctosp_project_name))
            project_path = remove_prefix(ctosp_project_name, 'platform/')
        elif args.path:
